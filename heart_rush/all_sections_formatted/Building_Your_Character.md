...
- A young character with 2 ranks might be talented in one field or dabbling in several
...
Each bloodmark you earn unlocks new abilities:
...
Paragon abilities have prerequisites indicating which abilities or talents you must already possess. These prerequisites ensure you've mastered foundational techniques before accessing legendary powers. Additionally, some paragon abilities require a minimum number of bloodmarks before you can select them.
...
_Passive ability. Talent: Beast Companion._
...
When starting at higher bloodmark levels, you choose your abilities from the pools above (Specializations, Signature Abilities, Combat Masteries, and Paragon Abilities based on your bloodmark level). You also receive the listed starting XP to spend on talents, aspects, hit points, and ability dice.
