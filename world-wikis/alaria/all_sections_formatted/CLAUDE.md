# Alaria Formatted Sections

This directory contains aggregated, formatted versions of Alaria world wiki content organized by major topic.
...
- Parent organization: `world-wikis/alaria/` category subdirectories
- Compilation script: `scripts/compile-content.ts`
- Navigation config: `world-wikis/alaria/navigation-categories.json`
